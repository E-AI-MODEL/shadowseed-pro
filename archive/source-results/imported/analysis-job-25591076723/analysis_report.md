...
Publicatiemodus: **workflow snapshot**.
...
Deze conclusie geldt alleen voor de huidige suite, het gebruikte model en de vastgelegde prompts. Voor een algemene claim zijn meer scenario's, meerdere modellen, sterkere adversarial evaluatie en blind review nodig.
...
| Adversarial Gate current FP rate | n/a |
| Adversarial Gate trace-only FP rate | n/a |
| Adversarial Gate reduction vs trace-only | n/a |
