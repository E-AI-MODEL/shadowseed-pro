...
DEFAULT_SOURCE_REGISTRY = "shadowseed:data/open_set_hf_sources.json"
...
def _registry_text(registry_path: str) -> str:
    if registry_path == DEFAULT_SOURCE_REGISTRY:
        return (
            resources.files("shadowseed")
            .joinpath("data", "open_set_hf_sources.json")
...
def _load_source(registry_path: str, source_id: str) -> dict[str, Any]:
    registry = json.loads(_registry_text(registry_path))
