...
from shadowseed_research.benchmark.ssl45_gap_suite import lexical_embedding
...
def test_vectorstore_smoke_runs_and_passes(tmp_path: Path):
    from shadowseed_research.benchmark.vectorstore_smoke import run_vectorstore_smoke
