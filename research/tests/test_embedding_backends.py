...
from shadowseed_research.benchmark.ssl_vs_rag_benchmark import run_ssl_vs_rag_benchmark
...
def test_ssl_vs_rag_runs_with_openai_embeddings(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "shadowseed_research.benchmark.ssl_vs_rag_benchmark.make_embedding_fn", fake_make
    )
