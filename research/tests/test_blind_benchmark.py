...
from shadowseed_research.benchmark.blind.detector import detect_blind_candidates
from shadowseed_research.benchmark.blind.loader import BlindBenchmarkInputError, load_public_suite
from shadowseed_research.benchmark.blind.runner import run_blind_benchmark
...
def test_blind_detector_does_not_reference_private_label_fields():
    source = Path("research/src/shadowseed_research/benchmark/blind/detector.py").read_text(encoding="utf-8")
