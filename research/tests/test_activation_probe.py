...
from shadowseed_research.benchmark.activation_probe import (
    FakeActivationModel,
    class_separation,
    probe_report,
    find_focus_span,
...
from shadowseed_research.benchmark.dialectic_falsification import build_dialectic_prompt
...
def test_l1_fit_survives_exactly_centered_data():
    ...
    from shadowseed_research.benchmark.activation_probe import _fit_l1_logistic_batch
...
def test_probe_touches_no_seed_state():
    ...
    import shadowseed_research.benchmark.activation_probe as mod
