...
Evidence-efficacy bundles, introduced with the 0.6.0 research harness and retained in 0.7.2, are **not privacy-minimized support bundles**. They are research artifacts and can contain:
...
Version 0.7.2 has no automatic cloud workspace upload. Hosted model/embedding calls remain explicit provider interactions rather than workspace synchronization.
