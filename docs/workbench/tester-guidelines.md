...
- On macOS, can the exact published ZIP be downloaded, extracted, and opened through the documented credential-free first-launch helper when browser quarantine blocks the app?
